...
<head>
    ...
    <title>404</title>
    <link rel="icon" href="https://images-na.ssl-images-amazon.com/images/I/41vPwmXL-dL.png" type="image/x-icon" />
    <style>
        ...
        .errorWrap a{display:inline-block;text-decoration: none;height:32px;background-color:#652f8f;font-size:15px;color:#fff;font-weight:700;line-height:32px;padding:0 20px;margin:15px 0 0;border-radius:2px}
...
<body>
    <div class="errorWrap">
        ...
        <p>Xin lỗi, liên kết đã hết hạn hoặc không tồn tại !.</p>
        <a class="homepage" href="<?=DOMAIN?>/trang-chu.html"><i class="fas fa-home"></i>
        Về trang chủ</a>
        </div>
</body>
</html>